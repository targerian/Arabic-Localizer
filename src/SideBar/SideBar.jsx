...
const sideData = [
  ...
  {name:"Inbound Requests", icon: <FaPrayingHands className="side-bar-icon"/>},
...
const SideBar = ({modalOpen}) => {
  return (
    <div className={`side-bar-container d-flex flex-column justify-content-start align-items-center py-5 `} >
      {
        sideData.map(element=> <div className="d-flex flex-column justify-content-center align-items-center my-3 px-2 py-1 element-container">
          {element.icon}
